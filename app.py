...
#server_url="https://schoolproject.piyushadlakha.repl.co/"
...
def add():
  ...
  if request.method=="POST":
    ...
    con.commit()
    check=rq.get(request.base_url.replace('add',"check_send"))
...
def index():
 ...
 # cur=curso(con)
  ...
  if len(lal)!=0:
    ...
    return render_template("nor.html",line1="NO REMINDER",line2="FOUND")
...
#<div class="template" ><h3><center>Email:- {{mail}}</h3><br><h3>Date To Send On:- {{date}}</h3><br><h3>Message:- {{text}}</h3></center></div><br><br>
#<div class="template" ><
